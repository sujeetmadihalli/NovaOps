document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateWinRate(incidents) {
        ...
        const automated = incidents.filter(inc =>
            inc.proposed_tool && inc.proposed_tool !== 'noop_require_human' && inc.proposed_tool !== 'unknown'
        ).length;
        const pct = Math.round((automated / incidents.length) * 100);
