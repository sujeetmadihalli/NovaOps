...
class BaseJuror:
    ...
    def _mock_deliberate(self) -> Dict[str, Any]:
        """Default mock verdict — subclasses override this with realistic mock data."""
        return {
            "juror": self.name,
    ...
    def deliberate(self, incident_context: Dict[str, Any]) -> Dict[str, Any]:
        """
        Sends this juror's focused context slice to the LLM and parses the verdict.
        Returns a structured verdict dict regardless of success or failure.
        """
