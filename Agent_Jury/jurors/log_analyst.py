...
"""
    ...
    def _mock_deliberate(self) -> Dict[str, Any]:
        return {
            ...
            "reasoning": "Fatal OOM errors appear in 3 consecutive log lines at 14:32 UTC. Pattern started 15 mins after deploy. Stack trace points to unconstrained memory allocation in the new build."
        }
